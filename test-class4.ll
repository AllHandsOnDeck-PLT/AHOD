...
entry:
  ...
  %setplayerscore = call i32 @setplayerscore({ i8*, i32 } %player4, i32 1)
  %player5 = load { i8*, i32 }, { i8*, i32 }* @player
  %getplayername6 = call i8* @getplayername({ i8*, i32 } %player5)
  %printf7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str, i32 0, i32 0), i8* %getplayername6)
  %player8 = load { i8*, i32 }, { i8*, i32 }* @player
  %getplayerscore9 = call i32 @getplayerscore({ i8*, i32 } %player8)
  %printf10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str.1, i32 0, i32 0), i32 %getplayerscore9)
  ret i32 0
}
