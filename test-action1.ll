...
@str.5 = private unnamed_addr constant [23 x i8] c"two actions are cooler\00"
...
define void @PLAYTWO() {
entry:
  %printf = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str, i32 0, i32 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @str.5, i32 0, i32 0))
  ret void
}
