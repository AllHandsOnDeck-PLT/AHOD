...
@type1 = global { i8*, i1 } zeroinitializer
@card3 = global { i8*, i1 } zeroinitializer
@card1 = global { i8*, i1 } zeroinitializer
@card2 = global { i8*, i1 } zeroinitializer
@deck = global { i32*, { i8*, i1 }* } zeroinitializer
@i = global i32 0
@str.4 = private unnamed_addr constant [3 x i8] c"R5\00"
@str.5 = private unnamed_addr constant [3 x i8] c"R6\00"
@str.6 = private unnamed_addr constant [3 x i8] c"R7\00"
...
entry:
  ...
  store { i8*, i1 } %cardcall, { i8*, i1 }* @card1
  %cardcall1 = call { i8*, i1 } @cardcall(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @str.5, i32 0, i32 0), i1 false)
  store { i8*, i1 } %cardcall1, { i8*, i1 }* @card2
  %cardcall2 = call { i8*, i1 } @cardcall(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @str.6, i32 0, i32 0), i1 true)
  store { i8*, i1 } %cardcall2, { i8*, i1 }* @card3
  ...
  %card1 = load { i8*, i1 }, { i8*, i1 }* @card1
  call void @series_pushcard({ i32*, { i8*, i1 }* }* %new_series_ptr, { i8*, i1 } %card1)
  %card2 = load { i8*, i1 }, { i8*, i1 }* @card2
  call void @series_pushcard({ i32*, { i8*, i1 }* }* %new_series_ptr, { i8*, i1 } %card2)
  %card3 = load { i8*, i1 }, { i8*, i1 }* @card3
  call void @series_pushcard({ i32*, { i8*, i1 }* }* %new_series_ptr, { i8*, i1 } %card3)
...
while:                                            ; preds = %while_body, %entry
  %i6 = load i32, i32* @i
  %series_size7 = call i32 @series_sizecard({ i32*, { i8*, i1 }* }* @deck)
  %tmp8 = icmp slt i32 %i6, %series_size7
  br i1 %tmp8, label %while_body, label %merge

while_body:                                       ; preds = %while
  %i = load i32, i32* @i
  %series_get = call { i8*, i1 } @series_getcard({ i32*, { i8*, i1 }* }* @deck, i32 %i)
  store { i8*, i1 } %series_get, { i8*, i1 }* @type1
  %type1 = load { i8*, i1 }, { i8*, i1 }* @type1
  %getcardtype = call i8* @getcardtype({ i8*, i1 } %type1)
  %printf = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str, i32 0, i32 0), i8* %getcardtype)
  %type13 = load { i8*, i1 }, { i8*, i1 }* @type1
  %getcardfaceup = call i1 @getcardfaceup({ i8*, i1 } %type13)
  %printf4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str.3, i32 0, i32 0), i1 %getcardfaceup)
  %i5 = load i32, i32* @i
  %tmp = add i32 %i5, 1
  store i32 %tmp, i32* @i
  br label %while
