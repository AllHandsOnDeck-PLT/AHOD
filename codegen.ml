...
let translate (globals, action_decls, action_decl) =
  ...
  and series_t t   = L.struct_type context [| L.pointer_type (L.i32_type context); (L.pointer_type t) |] in
  ...
  let build_action_body adecl =
    ...
    (* let _ = build_action_body2 builder the_action adecl in  *)
    let local_vars =
  ...
  let _ = build_action_body action_decl in
  the_module; 